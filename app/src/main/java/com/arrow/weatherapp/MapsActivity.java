...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppCompatButton btn_add_report = findViewById(R.id.btn_add_report);
        btn_add_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MapsActivity.this, AddReportActivity.class)
                        .putExtra(Constants.KEY_LAT, lat)
                        .putExtra(Constants.KEY_LONG, lng));
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.my_report:
                ...
                startActivity(new Intent(MapsActivity.this, MyReportActivity.class));
                return true;
...
//        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker under my foot"));
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
            Log.e(TAG, "onConnected " + location.getLatitude() + " " + location.getLongitude());
        } else {
